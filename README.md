...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/JRFjLvH9c3)
...
```sh
npx nx serve default-tenant
```

To create a production bundle:

```sh
npx nx build default-tenant
```

To see all available targets to run for a project, run:

```sh
npx nx show project default-tenant
```
